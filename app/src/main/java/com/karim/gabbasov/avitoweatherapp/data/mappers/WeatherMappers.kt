package com.karim.gabbasov.avitoweatherapp.data.mappers

import com.karim.gabbasov.avitoweatherapp.data.remote.ForecastsWeatherDto
import com.karim.gabbasov.avitoweatherapp.data.remote.WeatherDataDto
import com.karim.gabbasov.avitoweatherapp.data.remote.WeatherDto
import com.karim.gabbasov.avitoweatherapp.data.remote.WeatherLocationDto
import com.karim.gabbasov.avitoweatherapp.data.util.CalendarUtil.unixTimeToCalendar
import com.karim.gabbasov.avitoweatherapp.data.util.CalendarUtil.unixTimeToHours
import com.karim.gabbasov.avitoweatherapp.data.util.CalendarUtil.unixTimeToTomorrowDate
import com.karim.gabbasov.avitoweatherapp.data.util.HOURS_IN_A_DAY
import com.karim.gabbasov.avitoweatherapp.data.util.NamesOfDayOfWeek
import com.karim.gabbasov.avitoweatherapp.data.util.NamesOfDayOfWeek.Companion.toDayOfWeekName
import com.karim.gabbasov.avitoweatherapp.data.util.NamesOfMonths.Companion.toMonthName
import com.karim.gabbasov.avitoweatherapp.domain.weather.LocationModel
import com.karim.gabbasov.avitoweatherapp.domain.weather.WeatherForDayPartModel
import com.karim.gabbasov.avitoweatherapp.domain.weather.WeatherForHourModel
